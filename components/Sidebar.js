  ...
  return (
    <div className="p-2 md:p-10 py-6 overflow-y-auto border-b border-indigo-500/50">
      ...
      <div className="bg-gray-100 px-10 py-8 rounded-3xl w-[250px] text-center font-semibold">
        {/* SideBarRow */}
        <div className="bg-gray-300/60 py-2 px-2 rounded-xl mb-6 hover:bg-red-400/50 transition duration-150">
        ...
        <div className="bg-gray-300/60 py-2 px-2 rounded-xl  hover:bg-red-400/50 transition duration-150">
          <p className="text-gray-700">Math & Logic</p>
        </div>
      </div>
    </div>
  );
